...
export const discordIntegrationDeleteSecret = <ThrowOnError extends boolean = true>(options: Options<DiscordIntegrationDeleteSecretData, ThrowOnError>) => (options.client ?? client).delete<DiscordIntegrationDeleteSecretResponses, unknown, ThrowOnError, 'data'>({
    responseStyle: 'data',
    security: [{ scheme: 'bearer', type: 'http' }],
...
export const discordIntegrationPutSecret = <ThrowOnError extends boolean = true>(options: Options<DiscordIntegrationPutSecretData, ThrowOnError>) => (options.client ?? client).put<DiscordIntegrationPutSecretResponses, unknown, ThrowOnError, 'data'>({
    responseStyle: 'data',
    security: [{ scheme: 'bearer', type: 'http' }],
    url: '/api/v1/integrations/discord/secrets/{secretKey}',
    ...options,
...
export const serverOperationsGet = <ThrowOnError extends boolean = true>(options: Options<ServerOperationsGetData, ThrowOnError>) => (options.client ?? client).get<ServerOperationsGetResponses, unknown, ThrowOnError, 'data'>({
    responseStyle: 'data',
    security: [{ scheme: 'bearer', type: 'http' }],
...
export const worldOperationsUndoPreflight = <ThrowOnError extends boolean = true>(options: Options<WorldOperationsUndoPreflightData, ThrowOnError>) => (options.client ?? client).get<WorldOperationsUndoPreflightResponses, unknown, ThrowOnError, 'data'>({
    responseStyle: 'data',
    security: [{ scheme: 'bearer', type: 'http' }],
