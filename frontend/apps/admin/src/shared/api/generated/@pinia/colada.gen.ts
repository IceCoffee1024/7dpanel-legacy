...
export const serverOperationsGetQueryKey = (options: Options<ServerOperationsGetData>) => createQueryKey('serverOperationsGet', options, ['ServerOperations']);

export const serverOperationsGetQuery = defineQueryOptions<Options<ServerOperationsGetData>, ServerOperationsGetResponse, Error>((options: Options<ServerOperationsGetData>) => ({
    key: serverOperationsGetQueryKey(options),
    query: async (context) => await serverOperationsGet({
        ...options,
        ...context,
        throwOnError: true
    })
