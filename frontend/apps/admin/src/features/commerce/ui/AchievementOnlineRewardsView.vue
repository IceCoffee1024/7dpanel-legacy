...
import type { AchievementDefinitionDraft, AchievementStatistic, EvidenceGapPolicy, ManualOnlineRewardInput, OnlineRewardRuleDraft } from '../api/commerce'
...
const statisticItems = computed(() => [
  ...
  { label: t('commerce.achievementOnline.statistic.PlayerKills'), value: 'PlayerKills' },
  { label: t('commerce.achievementOnline.statistic.Deaths'), value: 'Deaths' },
])
const gapPolicyItems = computed(() => [
