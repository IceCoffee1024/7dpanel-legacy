...
export function fetchPanelUsers(authorization: string) {
  return list('/api/v1/panel-users', authorization, parsePanelUser)
}
export function fetchGameAdmins(authorization: string) {
  return list('/api/v1/game-permissions/admins', authorization, parseGameAdmin)
}
export function fetchCommandPermissions(authorization: string) {
  return list('/api/v1/game-permissions/commands', authorization, parseCommandPermission)
}
...
export function resetPanelUserPassword(authorization: string, subject: string, password: string) {
  return requestJson<void>(`/api/v1/panel-users/${encodeURIComponent(subject)}/password`, {
    method: 'POST',
    headers: { 'Authorization': authorization, 'Content-Type': 'application/json' },
...
export function deletePanelUser(authorization: string, subject: string) {
  return requestJson<void>(`/api/v1/panel-users/${encodeURIComponent(subject)}`, {
    method: 'DELETE',
