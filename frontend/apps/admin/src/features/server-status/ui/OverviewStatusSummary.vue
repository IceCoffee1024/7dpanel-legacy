...
const players = computed(() => {
  const online = props.game?.runtimeMetrics?.onlinePlayerCount.value ?? null
...
const framesPerSecond = computed(() => props.game?.runtimeMetrics?.framesPerSecond.value ?? null)
const gameDayTime = computed(() => props.game?.runtimeMetrics?.gameDayTime.value ?? null)
