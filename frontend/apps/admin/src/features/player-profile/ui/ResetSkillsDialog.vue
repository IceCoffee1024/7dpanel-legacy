...
<template>
  <PlayerActionDialogFrame
    ...
    :title="t('players.profile.actions.resetSkills.title')"
    :description="t('players.profile.actions.resetSkills.description')"
    :confirm-label="t('players.profile.actions.resetSkills.confirm')"
    @close="emit('close')"
