...
describe('locale messages', () => {
  ...
  it('contains the complete overview dashboard and independent operation messages', () => {
    const requiredKeys = [
      ...
      'operationStatus.result-unknown',
      'operationStatus.rollback-failed',
  ...
  it('contains messages for browser-rendered dynamic labels', () => {
    const gameCommandIds = [
      'Balance',
      'Pay',
      'MoneyTop',
      'Daily',
    ...
    const teleportSettingFields = [
      ...
      'bloodMoonMessage',
      'bloodMoonRestriction',
      'denyDuringBloodMoon',
    ]
    const serverConfigurationFields = [
      'ServerName',
      'ServerDescription',
      'ServerWebsiteURL',
      'ServerPassword',
    ...
    const requiredKeys = [
      ...
      'gameChat.settings.fields.allowNoPrefix',
      'gameChat.settings.fields.allowNoPrefixDescription',
      'gameChat.settings.fields.commandParameterSeparator',
      'gameChat.settings.fields.commandParameterSeparatorDescription',
      'gameChat.settings.fields.hideRegisteredCommandGlobalMessages',
      'gameChat.settings.fields.hideRegisteredCommandGlobalMessagesDescription',
      'permissions.panelUsers.role',
      'permissions.fields.permissionLevel',
      'community.gameCommands.title',
      'community.gameCommands.description',
      'community.gameCommands.subject',
      'community.gameCommands.version',
      'community.gameCommands.name',
      'community.gameCommands.aliases',
      'community.gameCommands.aliasesHint',
      'community.gameCommands.immediateHint',
      'community.gameCommands.save',
      ...gameCommandIds.map(id => `community.gameCommands.commandLabels.${id}`),
      ...teleportSettingFields.map(field => `community.teleportSetting.${field}`),
      ...serverConfigurationFields.map(field => `serverConfiguration.fields.${field}`),
    ]
