...
namespace LSTY.SevenDPanel.Adapters.Persistence.Sqlite.Economy
{
    ...
    {
        private const string AccountSelect = @"SELECT
        ...
        private const string TransactionSelect = @"SELECT
        ...
        private const string EntrySelect = @"SELECT
        ...
        private const string ReservationSelect = @"SELECT
        ...
        private static LedgerWriteResult LoadWriteResult(
            SqliteConnection connection,
            SqliteTransaction transaction,
            string transactionId)
        {
        ...
        private static IReadOnlyList<EntryRow> LoadEntries(
            SqliteConnection connection,
            SqliteTransaction? transaction,
        ...
        private static FundsReservationResult ToReservationResult(
        ...
        private static TransactionRow? FindTransactionByIdempotency(
            SqliteConnection connection,
            SqliteTransaction transaction,
        ...
        private static AccountRow? FindPlayerAccount(
            SqliteConnection connection,
            SqliteTransaction transaction,
        ...
        private static AccountRow GetAccount(
            SqliteConnection connection,
            SqliteTransaction transaction,
        ...
        private static AccountSnapshot ToAccount(AccountRow row) => new AccountSnapshot(
            row.AccountId,
        ...
        private static LedgerTransactionSnapshot ToTransaction(
            TransactionRow row,
